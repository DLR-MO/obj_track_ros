...
public:
  Ros2ColorCamera(rclcpp::Node *node, const std::string &name,
                  const std::string &img_topic, const std::string &info_topic,
                  const std::string &frame, bool publish_overlay);
...
public:
  Ros2DepthCamera(rclcpp::Node *node, const std::string &name,
                  const std::string &img_topic, const std::string &info_topic,
