...
class ObjTrackRosNode : public rclcpp::Node,
...
private:
  ...
  void
  receiveTrackedBody(const obj_track_ros::msg::TrackedObject::SharedPtr msg);
  void receiveTrackerControl(
      const obj_track_ros::msg::TrackerControl::SharedPtr msg);
  void createBody(const obj_track_ros::msg::TrackedObject::SharedPtr msg,
  ...
  rclcpp::Subscription<obj_track_ros::msg::TrackedObject>::SharedPtr
      tracked_obj_sub;
  rclcpp::Subscription<obj_track_ros::msg::TrackerControl>::SharedPtr
      tracker_control_sub;
  rclcpp::Publisher<obj_track_ros::msg::TrackResult>::SharedPtr
      track_result_pub;
  std::unordered_map<std::string, obj_track_ros::msg::TrackedObject::SharedPtr>
      name_to_tracked_obj;
